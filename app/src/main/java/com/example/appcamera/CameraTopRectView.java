...
class CameraTopRectView extends View {
    ...
    private static final String TIPS = "請對準指針表";
...
//        viewHeight = panelHeght - (int) DisplayUtil.dp2px(activity,TOP_BAR_HEIGHT + BOTTOM_BTN_HEIGHT);
    ...
    public void onDraw(Canvas canvas) {
        ...
        String[] qrArray;
        qrArray = mtext.split("/");
        canvas.drawText(TIPS + qrArray[6], rect.centerX(), baseline, wordPaint);
        ...
        outPaint.setStrokeWidth(LINE_WIDTH);// 線寬
        outPaint.setAlpha(255);
        outPaint.setColor(Color.rgb(255, 255, 0));
        canvas.drawCircle((rectLeft+rectRight)/2,(rectTop+rectBottom)/2,320,outPaint);
    }
